...
- Prompt-injection concerns if SKILL.md exists: 0 SKILL.md file(s) found; not copied into active hub.
...
- What should only be used as reference: Reference for multi-panel SVG composition practices.
- What should be rejected: direct installation, hidden operational instructions, broad dependency adoption without need.
- Integration decision: partial
